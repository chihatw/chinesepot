  ...
  public: {
    ...
    Functions: {
      get_hanzis_by_consonants: {
        Args: { _consonants: string[]; _limit: number }
        Returns: {
          consonant: string
          created_at: string
          form: string
      ...
      get_hanzis_by_consonants_vowels: {
        Args: { _consonants: string[]; _limit: number; _vowels: string[] }
        Returns: {
          consonant: string
          created_at: string
          form: string
      ...
      get_hanzis_by_vowel_tone: {
        Args: { _limit: number; _tone: string; _vowel: string }
        Returns: {
          consonant: string
          created_at: string
          form: string
      ...
      get_hanzis_by_vowels: {
        Args: { _limit: number; _vowels: string[] }
        Returns: {
          consonant: string
          created_at: string
          form: string
